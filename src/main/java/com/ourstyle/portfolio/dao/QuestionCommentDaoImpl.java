...
public class QuestionCommentDaoImpl implements QuestionCommentDao {
    ...
    public int count(Integer bno) throws Exception {
        return session.selectOne(namespace+"questionCount", bno);
    } // T selectOne(String statement)

    @Override
    public int deleteAll(Integer bno) {
        return session.delete(namespace+"questionDeleteAll", bno);
    ...
    public List<CommentDto> selectAll(Integer bno) throws Exception {
        return session.selectList(namespace+"questionSelectAll", bno);
    } // List<E> selectList(String statement)

    @Override
    public CommentDto select(Integer cno) throws Exception {
        return session.selectOne(namespace + "questionSelect", cno);
