...
<script>
    $(document).ready(function(){
        ...
        $("#writeNewBtn").on("click", function(){
            location.href="<c:url value='/questionboard/write'/>";
        });
        $("#writeBtn").on("click", function(){
            let form = $("#form");
            form.attr("action", "<c:url value='/questionboard/write'/>");
        ...
        $("#modifyBtn").on("click", function(){
            ...
            form.attr("action", "<c:url value='/questionboard/modify${searchCondition.queryString}'/>");
            form.attr("method", "post");
            if(formCheck())
                form.submit();
        });
        $("#removeBtn").on("click", function(){
            ...
            let form = $("#form");
            form.attr("action", "<c:url value='/questionboard/remove${searchCondition.queryString}'/>");
            form.attr("method", "post");
            form.submit();
        });
        $("#listBtn").on("click", function(){
            location.href="<c:url value='/questionboard/list${searchCondition.queryString}'/>";
        });
    });
    ...
    let showList = function(bno) {
        $.ajax({
            type:'GET',       // 요청 메서드
            url: '/portfolio/questioncomments?bno=' + bno,  // 요청 URI
    ...
    $(document).ready(function(){
        ...
        $("#modBtn").click(function(){
            ...
            $.ajax({
                type:'PATCH',       // 요청 메서드
                url: '/portfolio/questioncomments/' + cno,  // 요청 URI
        ...
        $("#commentList").on("click", ".delBtn", function(){
            ...
            $.ajax({
                type:'DELETE',       // 요청 메서드
                url: '/portfolio/questioncomments/' + cno + '?bno=' + bno,  // 요청 URI
                success : function(result){
                    alert(result)
                    showList(bno);
                },
    ...
    let toHtml = function(comments) {
        ...
        comments.forEach(function(questioncomment){
            tmp += '<hr />'
            tmp += '<li data-cno=' + questioncomment.cno
            tmp += ' data-pcno=' + questioncomment.pcno
            tmp += ' data-bno=' + questioncomment.bno + '>'
            if(questioncomment.cno != questioncomment.pcno)
                tmp += 'ㄴ'
            tmp += '<span class="commenter">' + questioncomment.commenter + ' /</span>'
            tmp += '&nbsp'
            tmp +=  questioncomment.up_date
            tmp += '<br>'
            tmp += '<div style = "word-break:break-all"><span class="comment">' + questioncomment.comment + '</span></div>'
            tmp += '&nbsp'
