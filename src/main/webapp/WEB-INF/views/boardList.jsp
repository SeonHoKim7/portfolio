        ...
        <div class="notice-container">
            <div class="card">
                <div class="card-body">
                    ...
                    <p></p>
                    <p class="card-text"> 자유롭게 글을 작성하실 수 있습니다. 게시판 규정에 위배되지 않도록 주의해주세요! </p>
                </div>
            </div>
        </div>
        ...
        <table>
            ...
            <c:forEach var="boardDto" items="${list}">
                <tr>
                    ...
                    <td class="title" ><div class="ellipis"><a href="<c:url value="/board/read${ph.sc.queryString}&bno=${boardDto.bno}"/>"><c:out value="${boardDto.title}"/></a></div></td>
