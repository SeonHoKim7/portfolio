...
<script>
    $(document).ready(function(){
        ...
        $("#writeNewBtn").on("click", function(){
            location.href="<c:url value='/infoboard/write'/>";
        });
        $("#writeBtn").on("click", function(){
            let form = $("#form");
            form.attr("action", "<c:url value='/infoboard/write'/>");
        ...
        $("#modifyBtn").on("click", function(){
            ...
            form.attr("action", "<c:url value='/infoboard/modify${searchCondition.queryString}'/>");
            form.attr("method", "post");
            if(formCheck())
                form.submit();
        });
        $("#removeBtn").on("click", function(){
            ...
            let form = $("#form");
            form.attr("action", "<c:url value='/infoboard/remove${searchCondition.queryString}'/>");
            form.attr("method", "post");
            form.submit();
        });
        $("#listBtn").on("click", function(){
            location.href="<c:url value='/infoboard/list${searchCondition.queryString}'/>";
        });
    });
    ...
    let showList = function(bno) {
        $.ajax({
            type:'GET',       // 요청 메서드
            url: '/portfolio/infocomments?bno=' + bno,  // 요청 URI
    ...
    $(document).ready(function(){
        ...
        $("#modBtn").click(function(){
            ...
            $.ajax({
                type:'PATCH',       // 요청 메서드
                url: '/portfolio/infocomments/' + cno,  // 요청 URI
        ...
        $("#commentList").on("click", ".delBtn", function(){
            ...
            $.ajax({
                type:'DELETE',       // 요청 메서드
                url: '/portfolio/infocomments/' + cno + '?bno=' + bno,  // 요청 URI
                success : function(result){
                    alert(result)
                    showList(bno);
                },
    ...
    let toHtml = function(comments) {
        ...
        comments.forEach(function(infocomment){
            tmp += '<hr />'
            tmp += '<li data-cno=' + infocomment.cno
            tmp += ' data-pcno=' + infocomment.pcno
            tmp += ' data-bno=' + infocomment.bno + '>'
            if(infocomment.cno != infocomment.pcno)
                tmp += 'ㄴ'
            tmp += '<span class="commenter">' + infocomment.commenter + ' /</span>'
            tmp += '&nbsp'
            tmp +=  infocomment.up_date
            tmp += '<br>'
            tmp += '<div style = "word-break:break-all"><span class="comment">' + infocomment.comment + '</span></div>'
            tmp += '&nbsp'
