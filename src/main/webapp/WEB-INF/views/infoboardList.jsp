...
<div style="text-align:center">
    <div class="board-container">
        ...
        <div class="notice-container">
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title">정보공유 게시판</h5>
                    <p></p>
                    <p class="card-text">다룬 분들에게도 유용한 정보 및 팁을 공유해보세요!</p>
                </div>
            </div>
        </div>
        <div class="search-container">
            <form action="<c:url value="/infoboard/list"/>" class="search-form" method="get">
            ...
            <button id="writeBtn" class="btn-write" onclick="location.href='<c:url value="/infoboard/write"/>'"><i class="fa fa-pencil"></i>글쓰기</button>
        </div>
        ...
        <table>
            ...
            <c:forEach var="boardDto" items="${list}">
                <tr>
                    ...
                    <td class="title"><div class="ellipis"><a href="<c:url value="/infoboard/read${ph.sc.queryString}&bno=${boardDto.bno}"/>"><c:out value="${boardDto.title}"/></a></div></td>
            ...
            <div class="paging">
                ...
                <c:if test="${totalCnt!=null && totalCnt!=0}">
                    <c:if test="${ph.showPrev}">
                        <a class="page" href="<c:url value="/infoboard/list${ph.sc.getQueryString(ph.beginPage-1)}"/>">&lt;</a>
                    </c:if>
                    <c:forEach var="i" begin="${ph.beginPage}" end="${ph.endPage}">
                        <a class="page ${i==ph.sc.page? "paging-active" : ""}" href="<c:url value="/noticeboard/list${ph.sc.getQueryString(i)}"/>">${i}</a>
                    </c:forEach>
                    <c:if test="${ph.showNext}">
                        <a class="page" href="<c:url value="/infoboard/list${ph.sc.getQueryString(ph.endPage+1)}"/>">&gt;</a>
                    </c:if>
                </c:if>
            </div>
        </div>
