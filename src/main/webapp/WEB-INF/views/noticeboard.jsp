...
<c:set var="adminShowCheck" value="${loginId=='admin' ? 'inline' : 'none'}"/>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
...
<script>
    $(document).ready(function(){
        ...
        $("#writeNewBtn").on("click", function(){
            location.href="<c:url value='/noticeboard/write'/>";
        });
        $("#writeBtn").on("click", function(){
            let form = $("#form");
            form.attr("action", "<c:url value='/noticeboard/write'/>");
        ...
        $("#modifyBtn").on("click", function(){
            ...
            form.attr("action", "<c:url value='/noticeboard/modify${searchCondition.queryString}'/>");
            form.attr("method", "post");
            if(formCheck())
                form.submit();
        });
        $("#removeBtn").on("click", function(){
            ...
            let form = $("#form");
            form.attr("action", "<c:url value='/noticeboard/remove${searchCondition.queryString}'/>");
            form.attr("method", "post");
            form.submit();
        });
    ...
    let showList = function(bno) {
        $.ajax({
            type:'GET',       // 요청 메서드
            url: '/portfolio/noticecomments?bno=' + bno,  // 요청 URI
    ...
    $(document).ready(function(){
        ...
        $("#modBtn").click(function(){
            ...
            $.ajax({
                type:'PATCH',       // 요청 메서드
                url: '/portfolio/noticecomments/' + cno,  // 요청 URI
        ...
        $("#commentList").on("click", ".delBtn", function(){
            ...
            $.ajax({
                type:'DELETE',       // 요청 메서드
                url: '/portfolio/noticecomments/' + cno + '?bno=' + bno,  // 요청 URI
                success : function(result){
                    alert(result)
                    showList(bno);
                },
    ...
    let toHtml = function(comments) {
        ...
        comments.forEach(function(noticecomment){
            tmp += '<hr />'
            tmp += '<li data-cno=' + noticecomment.cno
            tmp += ' data-pcno=' + noticecomment.pcno
            tmp += ' data-bno=' + noticecomment.bno + '>'
            if(noticecomment.cno != noticecomment.pcno)
                tmp += 'ㄴ'
            tmp += '<span class="commenter">' + noticecomment.commenter + ' /</span>'
            tmp += '&nbsp'
            tmp +=  noticecomment.up_date
            tmp += '<br>'
            tmp += '<div style = "word-break:break-all"><span class="comment">' + noticecomment.comment + '</span></div>'
            tmp += '&nbsp'
